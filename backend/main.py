...
from db.startup_schema import (
    ...
    ensure_promo_code_allowed_duration_column,
    ensure_default_onboarding_promo_code,
    ensure_universal_promo_codes,
    ensure_promo_code_redemptions_table,
    ensure_user_welcome_promo_code,
...
async def lifespan(app: FastAPI):
    ...
    _run_startup_step("ensure_promo_code_allowed_duration_column", ensure_promo_code_allowed_duration_column)
    ...
    _run_startup_step("ensure_promo_code_redemptions_table", ensure_promo_code_redemptions_table)
    _run_startup_step("ensure_user_welcome_promo_code", ensure_user_welcome_promo_code)
