...
class Settings(BaseSettings):
    ...
    #: Shared booking promo for new users (first 5-minute booked session free). Empty = skip seed.
    user_welcome_promo_seed_code: str = "WELCOME5"
    user_welcome_promo_duration_minutes: int = 5
