...
def apply_card_visibility_to_public(
    ...
    # Do not clear session_packages_available from visibility — that flag is approval/capability.
    # Frontends hide packages via public_card_visibility.session_packages.
