...
class User(Base):
    ...
    chat_purchases = relationship("ChatPurchase", back_populates="user", passive_deletes=True)
    waitlist_entries = relationship("WaitlistEntry", back_populates="user", passive_deletes=True)
