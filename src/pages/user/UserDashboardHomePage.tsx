...
import { getUserDashboardStats, getUserSpendingSeries, getWelcomePromo, type AnalyticsPeriod } from "@/api/users";
        ...
        <Card className="border-primary/30 bg-primary/5">
          <CardHeader className="flex flex-row items-start gap-3 space-y-0 pb-2">
            ...
            <div className="space-y-1">
              <CardTitle className="text-lg">{du.welcomePromoTitle}</CardTitle>
              <CardDescription>
                {du.welcomePromoBody
                  .replace("{minutes}", String(welcomePromoQ.data.duration_minutes))
                  .replace("{code}", welcomePromoQ.data.code)}
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent>
