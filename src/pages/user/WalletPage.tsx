...
const WalletPage = () => {
  ...
  }, [queryClient, searchParams, setSearchParams, navigate, returnTo, w.topupFailed, w.topupPending, w.topupSuccess]);
  ...
  const onPay = async () => {
    ...
    setPaying(true);
    try {
      const out = await createWalletTopupIntent({ amount, currency: "EUR", return_path: returnTo });
