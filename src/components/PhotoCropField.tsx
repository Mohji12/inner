...
import { formatUploadError, validateImageFile, MAX_ORIGINAL_IMAGE_BYTES } from "@/lib/imageUpload";
...
export function PhotoCropField({
  ...
  const onPickFile = (file: File | undefined) => {
    ...
    const validation = validateImageFile(
      file,
      "Image is too large (max 12 MB). Please choose a smaller JPG or PNG.",
