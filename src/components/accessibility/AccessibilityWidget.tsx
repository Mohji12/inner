    ...
    <Sheet>
      <SheetTrigger asChild>
        <Button
          type="button"
          variant="ghost"
          className="fixed bottom-4 right-4 z-[2147483647] h-6 w-6 rounded-full p-0 shadow-lg hover:bg-transparent hover:opacity-90 md:bottom-5 md:right-5 [&_svg]:!size-full"
          title={a.openPanel}
        >
