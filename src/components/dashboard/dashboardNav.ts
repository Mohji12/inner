...
export const dashboardChromeHeaderClass =
  "relative z-30 flex h-14 min-w-0 items-center gap-2 overflow-visible border-b border-border/60 bg-background/80 px-3 backdrop-blur transition-colors duration-200 sm:h-16 sm:px-6";
