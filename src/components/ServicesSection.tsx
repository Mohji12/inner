...
const SERVICE_CARD_IMAGES = [
  encodeURI("/WhatsApp Image 2026-05-27 at 15.02.16.jpeg"),
    ...
    <section id="services" className="py-24 md:py-32 bg-cream">
      <div ref={ref} className="section-reveal container mx-auto px-6">
        <div className="mb-16 text-center">
          ...
          <h2 className="mt-3 text-balance text-3xl font-serif font-semibold tracking-tight md:text-4xl lg:text-5xl">
            {t.services.heading}
          </h2>
        </div>
          ...
          {t.services.items.map((s, i) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col px-5 pb-6 pt-5 md:px-6 md:pb-7 md:pt-6">
                <h3 className="text-balance font-serif text-lg font-semibold leading-snug tracking-tight md:text-xl">
                  {s.title}
                </h3>
